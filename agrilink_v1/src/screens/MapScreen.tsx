...
import { StyleSheet, View, AppState, AppStateStatus, Alert } from 'react-native';
...
const MapScreen = () => {
  ...
  }, [profileLoading, profile, loading, locationPermissionDenied]);
          ...
          {selectedFarmer && (
            <View>
              <View style={styles.farmerHeader}>
                <Avatar.Text
                  size={60}
                  label={selectedFarmer.name.split(' ').map(n => n[0]).join('')}
                />
              ...
              <List.Item
                ...
                left={props => <List.Icon {...props} icon={selectedFarmer.isOrganic ? 'leaf' : 'sprout'} />}
              />
