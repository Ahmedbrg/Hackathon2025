  ...
  const fetchPlantInformation = async () => {
    try {
      ...
      const params = new URLSearchParams({
        key: 'sk-15tJ680d79844166f10040',  // Replace with your Perenual API key
        page: '2',
        indoor: '1'
      });

      console.log('Fetching plants from:', `${apiUrl}?${params}`);
      ...
      console.log('Formatted plant items:', formattedPlants.length);
